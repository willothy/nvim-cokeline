...
local focus_on_delete = function(bufnr)
  ...
  local prev_buffer = _G.cokeline.valid_buffers[
    deleted_buffer._valid_index ~= 1
    and deleted_buffer._valid_index - 1
     or 2
  ]

  local next_buffer = _G.cokeline.valid_buffers[
    deleted_buffer._valid_index ~= #_G.cokeline.valid_buffers
    and deleted_buffer._valid_index + 1
